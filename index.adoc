...
- my reference: https://github.com/cplusplus/draft/tree/c++17[CPP ISO Draft]
...
-- Fabien C. Y. Benureau and ￼Nicolas P. Rougier, 2018, https://www.frontiersin.org/articles/10.3389/fninf.2017.00069/full[Frontiers in Neuroinformatics]
